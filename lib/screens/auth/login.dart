...
class _AuthScreenState extends State<AuthScreen> {
  ...
  Future<void> signInFunction(BuildContext context, String? priorPage,
  ...
  void _login({required String priorPage}) async {
              ...
              Padding(
                ...
                child: Center(
                  child: GoogleAuthButton(
                    onPressed: () async {
                      if (widget.priorPage == 'results_page') {
